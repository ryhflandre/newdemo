...
public class GenEntityOracle {
    ...
    private String packageOutPath = "main.java.com.renyuanhang.entity";// ָ��ʵ���������ڰ���·��
...
//    private static final String PASS = "tiger";
    private static final String URL="jdbc:mysql://localhost:3306/1705test?user=root&password=fulan&useUnicode=true&characterEncoding=UTF8";
...
//            return "Date";
    ...
    public static void main(String[] args) {  
        //�������Ǳ���  ���ɵ�ʵ������ĸ��д   ������User
    	//��һ����������    �ڶ�������ʵ������    �������������ݿ�����
        new GenEntityOracle("movie","Movie","1705test").init();  
        new GenEntityOracle("list","List","1705test").init();
        new GenEntityOracle("mlist","Mlist","1705test").init();
    }  
}